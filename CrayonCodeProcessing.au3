...
$TabSheet3 = GUICtrlCreateTabItem("Status Log")
$ELog = GUICtrlCreateEdit("", 8, 32, 593, 337, BitOR($GUI_SS_DEFAULT_EDIT,$ES_READONLY))
$I_AlchemyStoneTimer = GUICtrlCreateInput("", 16, 373, 81, 21, $ES_READONLY)
$TabSheet4 = GUICtrlCreateTabItem("Global Settings")
...
$Label11 = GUICtrlCreateLabel("Time in Minutes. Set 0 to Deactivate. NOT IMPLEMENTED YET.", 272, 160, 313, 17)
$Label12 = GUICtrlCreateLabel("Time before Processing stop will be counted as success in Seconds.", 272, 112, 327, 17)
$Label13 = GUICtrlCreateLabel("Items taken from storage. Customize depending on your LT.", 272, 64, 284, 17)
$CB_AlchemyStone = GUICtrlCreateCheckbox("Enable Alchemy Stone", 24, 288, 129, 17)
$Label14 = GUICtrlCreateLabel("Will press U every 10 minutes.", 176, 288, 146, 17)
GUICtrlCreateTabItem("")
$BSave = GUICtrlCreateButton("Save Settings", 8, 400, 100, 33)
$BCustom = GUICtrlCreateButton("Start Custom [F4]", 256, 400, 100, 33)
$BSimple = GUICtrlCreateButton("Start Simple [F5]", 128, 400, 100, 33)
...
Func InitGUI()
	...
	Global $ore_array[11] = [$ore_copper, $ore_gold, $ore_iron, $ore_lead, $ore_mythril, $ore_platinum, $ore_silver, $ore_tin, $ore_titanium, $ore_vanadium, $ore_zinc]
...
Func OCInventory($open = True) ; Adpated (Removed $Fish)
	...
	While Not $IS And $Processing
		Sleep(250)
		$IS = _ImageSearchArea("res/reference_inventory.bmp", 0, $ResOffset[0], $ResOffset[1], $ResOffset[2], $ResOffset[3], $C[0], $C[1], 10, 0)
		Sleep(250)
		If $IS = True Then
			If $open = True Then
				$C[0] += $Offset[0]
...
Func ProductionMethod($Method) ; 0=Shaking, 1=Grinding, 2=Chopping, 3=Drying, 4=Filtering, 5=Heating
	...
	Local $x, $y, $IS
	Local $ProductionHammer = "res/processing_hammer.bmp"
...
Func AlchemyStone()
	...
	Local Static $AlchemyStoneCooldown = 601000
	...
	Else
		...
		If $AlchemyStoneTimerDiff >= $AlchemyStoneCooldown Then
			SetGUIStatus("Using Alchemy Stone")
			CoSe("u")
...
Func ProductionActivityCheck() ; Adpated
	Local Const $Processing_Hammer = "res/processing_hammer.bmp"
	Local $IS, $x, $y
	GSleep(500)
